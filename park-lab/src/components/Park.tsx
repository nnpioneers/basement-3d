...
const TRACK_COLOR = '#7a3020';
const PATH_COLOR  = '#d4b87a';
const PAVE_COLOR  = '#dcc89a';
const GRASS_INNER = '#3da85a';
...
export function OuterTrack() {
  ...
  return (
    <mesh geometry={geom} rotation={[-Math.PI / 2, 0, 0]} position={[0, 0.04, 0]} receiveShadow castShadow>
      <meshStandardMaterial color={TRACK_COLOR} roughness={0.92} />
    </mesh>
  );
}
...
export function InnerLawn() {
  ...
  return (
    <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, 0.03, 0]} receiveShadow>
      ...
      <meshStandardMaterial color={GRASS_INNER} roughness={0.88} />
    </mesh>
  );
}
