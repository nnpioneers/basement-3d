...
export default function Roundabout() {
  ...
  return (
    <group matrixAutoUpdate={false} onUpdate={(c: any) => c.updateMatrix()} position={[0, 0, 0]}>
      {/* Base Grass Island */}
      <mesh position={[0, grassHeight / 2, 0]} matrixAutoUpdate={false} onUpdate={(c: any) => c.updateMatrix()}>
      ...
      <mesh position={[0, pathHeight / 2, 0]} matrixAutoUpdate={false} onUpdate={(c: any) => c.updateMatrix()}>
      ...
      {[
        ...
        <group matrixAutoUpdate={false} onUpdate={(c: any) => c.updateMatrix()} key={index} position={[pos.x, grassHeight + 0.3, pos.z]}>
          <mesh matrixAutoUpdate={false} onUpdate={(c: any) => c.updateMatrix()}>
