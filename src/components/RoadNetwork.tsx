...
function RoadNetwork() {
  ...
  return (
    <group rotation={[-Math.PI / 2, 0, 0]}>
      ...
      <Line points={shapeLines} color="#000000" lineWidth={1.5} opacity={1.0} transparent raycast={() => null} />
      {holeLines.map((pts, i) => (
        <Line key={`hole-${i}`} points={pts} color="#000000" lineWidth={1.5} opacity={1.0} transparent raycast={() => null} />
      ))}
